...
module.exports = {
    ...
    .setName("play")
    .setDescription("lpads songs from youtube")
    ...
    run: async ({client, interaction}) => {
        ...
        if(interaction.options.getSubcommand() === "song"){
        ...
        } else if (interaction.opotions.getSubcommand() === "playlist"){
            let url = interaction.options.getString("url")
            const result = await client.player.search(url, {
                requiredBy: interaction.user,
            ...
            embed
            .setDescription(`**${result.tracks.length} songs from [${playlist.title}]${playlist.url}** added to the queue`)
